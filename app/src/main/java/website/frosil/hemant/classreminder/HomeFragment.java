...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        LinearLayout myLayout = (LinearLayout) view.findViewById(R.id.ll_home);

        listView1 = (ListView) myLayout.findViewById(R.id.list2);
        strtext = getArguments().getString("s_ID");
        name = getArguments().getString("name");
        final TextView welcome_login = (TextView) myLayout.findViewById(R.id.textView_login);
        final TextView rem_txt = (TextView) myLayout.findViewById(R.id.textView_list);
        welcome_login.setText("Welcome  " + name);
        return view;
    }
    ...
    private class AsyncConnection extends AsyncTask {
        ...
        protected Object doInBackground(Object... params) {
            try {
                ...
                OtherActRemServ service = new OtherActRemServ(weekDay, strtext);
        ...
        protected void onPostExecute(Object result) {
            ListAdapter adapter = new SimpleAdapter(getActivity(), list1, R.layout.oa_reminder, new String[]{"class_id1", "class_day1", "class_time1"},
